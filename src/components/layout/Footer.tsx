          ...
          <div className="flex flex-wrap justify-center gap-x-5 gap-y-1">
            {[
              ...
              <span key={link.href} className="flex items-center gap-x-5">
                <Link href={link.href} className="text-gold-500/30 hover:text-gold-400 text-[11px] transition-all duration-300 hover:underline underline-offset-4 decoration-gold-500/30">
                  {link.label}
                </Link>
                {i < 3 && <span className="text-gold-500/10 text-[8px]">•</span>}
              </span>
            ))}
          </div>
        </div>
