...
export default function CTASection() {
  return (
    <section className="py-14 relative overflow-hidden">
      ...
      {/* Gold glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-gold-500/[0.05] rounded-full blur-[100px]" />

      {/* Top & bottom borders */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold-500/30 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold-500/30 to-transparent" />

      <div className="relative mx-auto max-w-[960px] px-4 sm:px-6 lg:px-8 text-center">
        <AnimateIn>
          {/* Ornamental top */}
          <div className="flex items-center justify-center gap-4 mb-8">
            <div className="w-12 h-px bg-gradient-to-r from-transparent to-gold-500/30" />
            <div className="w-2 h-2 rounded-full bg-gold-500/25" />
            <div className="w-12 h-px bg-gradient-to-l from-transparent to-gold-500/30" />
          </div>
